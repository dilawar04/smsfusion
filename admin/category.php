                       ...
                       <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php 
                                    ...
                                    $query = mysqli_query($connection, "SELECT * FROM category") or die(
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="delete_category.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this message?')" class="label label-important singleDelete"> <i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>
                            <?php  }  ?>
                        </tbody>
